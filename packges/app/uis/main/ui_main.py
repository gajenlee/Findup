...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_icon_inter = QLabel(self.frame_logo_icon)
        self.label_icon_inter.setObjectName(u"label_icon_inter")
        self.label_icon_inter.setMinimumSize(QSize(210, 210))
        self.label_icon_inter.setMaximumSize(QSize(210, 210))
        self.label_icon_inter.setStyleSheet(u"QLabel{\n"
                                            "   border: 8px solid rgb(37, 38, 48);\n"
                                            "   background-color: rgb(50, 52, 65);\n"
                                            "   border-radius: 105px;\n"
                                            "}")

        self.horizontalLayout_4.addWidget(self.label_icon_inter)
